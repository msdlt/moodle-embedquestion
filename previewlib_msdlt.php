<?php
// This file is adapted from previewlib.php which is part of Moodle core
//
// This adaptation is used for embedding untracked questions from the
// question bank into Moodle activities and other content.

// The aim of this adaptation is to remove elements from the preview.
// These include: buttons; configuration selectors; parts of the title.
// The information is suppressed by CSS.
// 
// The functionality of the preview is unchanged.
